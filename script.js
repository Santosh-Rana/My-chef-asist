...
function getSmartSystemPrompt(userMessage, userLanguage) {
    ...
    // CASE 3: DEFAULT RECIPE CHEF (Existing Logic)
        ...
        // For brevity, I am using a reference to the previous prompt logic:
         const recipePrompts = {
            en: `You are Chef Master AI. Provide a complete recipe for: ${userMessage}. Include Ingredients and Steps. Funny tone.`,
            hi: `आप Chef Master AI हैं। ${userMessage} के लिए पूरी रेसिपी बताएं। सामग्री और विधि शामिल करें।`,
            hinglish: `Tum Chef Master AI ho. ${userMessage} ki poori recipe batao. Ingredients aur Steps ke saath.`,
